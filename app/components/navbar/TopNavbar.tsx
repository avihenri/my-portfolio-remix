...
import { HomeButtonIcon } from "../buttons/HomeButtonIcon";
import { MenuButtonIcon } from "../buttons/MenuButtonIcon";
              ...
              <div className="flex justify-between items-center py-4">
                ...
                <div className="hidden sm:flex space-x-8 items-center">
                  <nav className="flex justify-center space-x-10 py-4">
                    <a
                      href="/projects"
                      className="text-black font-mono font-semibold dark:text-white"
                    >
                      Projects
                    </a>
                    <a
                  ...
                  <button>
                    <a href="https://github.com/avihenri" target="_blank" rel="noreferrer" aria-label="View GitHub Profile">
                      <motion.svg
                        viewBox="0 0 16 16"
                        fill="currentColor"
                        height="1em"
